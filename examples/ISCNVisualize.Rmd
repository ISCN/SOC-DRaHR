...
```{r loadData}
dataDir <- '~/Documents/Datasets/ISCN_3/'
if(file.exists(file.path(dataDir, 'ISCN3.RData'))){
  load(file.path(dataDir, 'ISCN3.RData'))
}else{
  ISCN3 <- processData_ISCN3(dataDir=dataDir, verbose=TRUE)
  save(ISCN3, file=file.path(dataDir, 'ISCN3.RData'))
}
```
```{r cleanUp}
